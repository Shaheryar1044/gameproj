...
final class Ocean_Posts_Slider {
	...
	public function ops_scripts() {
		...
		wp_enqueue_script( 'ops-js-scripts', plugins_url( '/assets/js/main.min.js', __FILE__ ), array( 'jquery', 'oceanwp-main' ), null, true );
	...
	public static function register_post_type() {
		register_post_type( 'ocean_posts_slider', apply_filters( 'ocean_posts_slider_args', array(
			'labels' => array(
	...
	public static function helpers( $return = NULL ) {
		...
		if ( 'post_type' == $return ) {
			...
			$get_post_types 	= get_post_types( array( 'public' => true, '_builtin' => false, ), 'objects', 'and' );
...
if ( ! function_exists( 'ocean_posts_slider_fs' ) ) {
    ...
    function ocean_posts_slider_fs() {
	    ...
	    if ( ! isset( $ocean_posts_slider_fs ) ) {
		    $ocean_posts_slider_fs = OceanWP_EDD_Addon_Migration::instance( 'ocean_posts_slider_fs' )->init_sdk( array(
			    'id'              => '3813',
