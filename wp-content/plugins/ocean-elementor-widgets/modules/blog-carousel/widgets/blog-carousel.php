...
class Blog_Carousel extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_group_control(
			...
			[
				'name' 			=> 'meta_typo',
				'selector' 		=> '{{WRAPPER}} .oew-carousel ul.meta li',
				'scheme' 		=> Scheme_Typography::TYPOGRAPHY_1,
			]
		);
	...
	protected function render() {
		...
		if ( $oew_query->have_posts() ) :
			...
			<div class="oew-carousel oew-carousel-blog clr" <?php echo $this->get_render_attribute_string( 'data' ); ?>>
				<?php
				// Start loop
									...
									if ( 'true' == $meta ) { ?>
										...
										<ul class="meta">
											...
											<?php if ( 'true' == $settings['author'] ) { ?>
												<li class="meta-author" itemprop="name"><i class="icon-user" aria-hidden="true"></i><?php echo the_author_posts_link(); ?></li>
											<?php } ?>

											<?php if ( 'true' == $settings['date'] ) { ?>
												<li class="meta-date" itemprop="datePublished" pubdate><i class="icon-clock" aria-hidden="true"></i><?php echo get_the_date(); ?></li>
											<?php } ?>

											<?php if ( 'true' == $settings['cat'] ) { ?>
												<li class="meta-cat"><i class="icon-folder" aria-hidden="true"></i><?php the_category( ' / ', get_the_ID() ); ?></li>
											<?php } ?>

											<?php if ( 'true' == $settings['comments'] && comments_open() && ! post_password_required() ) { ?>
												<li class="meta-comments"><i class="icon-bubble" aria-hidden="true"></i><?php comments_popup_link( esc_html__( '0 Comments', 'ocean-elementor-widgets' ), esc_html__( '1 Comment',  'ocean-elementor-widgets' ), esc_html__( '% Comments', 'ocean-elementor-widgets' ), 'comments-link' ); ?></li>
											<?php } ?>
